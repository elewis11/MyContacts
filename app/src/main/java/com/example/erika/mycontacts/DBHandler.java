...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        values.put(COLUMN_LIST_GROUP_NAME, "");
        values.put(COLUMN_LIST_GROUP_NAME, "Family");
        values.put(COLUMN_LIST_GROUP_NAME, "Friends");
        values.put(COLUMN_LIST_GROUP_NAME, "Work");
...
/*if names of the groups could be made from outside the database, this would be the code for it
    public void setGroupNames(String[] list, int groupCount){
        SQLiteDatabase db = getWritableDatabase();
        ContentValues values = new ContentValues();
